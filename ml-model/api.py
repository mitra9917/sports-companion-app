import os
# MAC FIX: These MUST be the absolute first lines in the file!
os.environ['OBJC_DISABLE_INITIALIZE_FORK_SAFETY'] = 'YES'
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '2' # Hides annoying TensorFlow warnings
...
# Waking up TensorFlow globally (Safe now because of the os.environ rules above)
try:
...
try:
    ...
    print("⚠️ Warning: scaler.save not found.")
    scaler = None
